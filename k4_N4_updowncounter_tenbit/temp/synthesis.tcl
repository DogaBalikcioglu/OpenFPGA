...
# arch file: /home/doga/Documents/OpenFPGA/k4_N4_updowncounter_tenbit/temp/k4_frac_N4_40nm.xml

# input files: [tenbit_up_downcounter.v]

# other args: []

# config file: /home/doga/Documents/OpenFPGA/k4_N4_updowncounter_tenbit/temp/odin_config.xml

# output file: tenbit_up_downcounter.parmys.blif



parmys_arch -a /home/doga/Documents/OpenFPGA/k4_N4_updowncounter_tenbit/temp/k4_frac_N4_40nm.xml
...
if {$env(PARSER) == "slang" } {
	...
	build_filelist {tenbit_up_downcounter.v} $readfile
	...
	read_verilog -sv -nolatches tenbit_up_downcounter.v
...
if {$env(PARSER) == "default" || $env(PARSER) == "slang"} {
    ...
    parmys -a /home/doga/Documents/OpenFPGA/k4_N4_updowncounter_tenbit/temp/k4_frac_N4_40nm.xml -nopass -c /home/doga/Documents/OpenFPGA/k4_N4_updowncounter_tenbit/temp/odin_config.xml 
...
write_blif -true + vcc -false + gnd -undef + unconn -blackbox tenbit_up_downcounter.parmys.blif
